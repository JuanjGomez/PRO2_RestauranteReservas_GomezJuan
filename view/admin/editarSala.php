...
<body class="body2">
    ...
    <h3>Editar Sala</h3>
    <div class="container">
        <form method="POST" id="crear" action="../../procesos/editarSalas.php" enctype="multipart/form-data">
            <div class="form-column">
                <input type="hidden" id="idSala" name="idSala" value="<?php echo $idSala ?>">
                <label for="nombreS">Nombre de la Sala: 
                    <input type="text" id="nombreS" name="nombreS" value="<?php echo $fila['nombre_sala']; ?>">
                </label>
                    ...
                    <select id="tipoSala" name="tipoSala">
                        ...
                        <?php
                            try{
                                ...
                                foreach($resultados as $tipoSalas){
                                    echo '<option value="' . $tipoSalas['id_tipoSala'] . '" ' . 
                                        (isset($fila['id_tipoSala']) && $fila['id_tipoSala'] == $tipoSalas['id_tipoSala'] ? 'selected' : '') . '>' .
                                        $tipoSalas['tipo_sala']. '</option>';
                                }
    ...
    <script src="../../validations/js/validaEditarSala.js"></script>
    <script>
